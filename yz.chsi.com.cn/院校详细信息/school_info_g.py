...
yjxkdms = ['0775']
zymcs = [
    ['计算机科学与技术', '计算机软件与理论','计算机系统结构','计算机应用技术','计算科学']
]
dirct={"0775":zymcs[0]}
        ...
        for yjxkdm in yjxkdms:
            for zymc in dirct[yjxkdm]:
                ...
                try:
                    ...
                    search= """https://yz.chsi.com.cn/zsml/querySchAction.do?ssdm={}&dwmc={}&mldm=07&mlmc=&yjxkdm={}&xxfs=1&zymc={}""".format(
                            dwmc,d, yjxkdm, zymc)
                    ...
                    for result in results:
                        ...
                        dfdata.to_csv('school_info_li.csv',index=False,encoding='utf_8_sig',mode='a',header=False)
                except:
                    print(search);